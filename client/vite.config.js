...
export default defineConfig(({ mode }) => {
  ...
  const stripeKey =
    mode === "production"
      ...
      : (import.meta.env?.VITE_STRIPE_PUBLISHABLE_KEY || "pk_test_51KiUrjF9MElxuMjviJAW9Uv4u6GiNL3HuovBIm6VTNzJo7deHAlkLyV2I9CyQcVgeB2JsUfRNqtRpg6JJPJlK93m00n4W0mWKp");
